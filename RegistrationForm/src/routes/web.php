...
Route::get('Registration-Form2',[RegistrationController::class,'registration2'])->name('registration2');
Route::post('Registration-Form2',[RegistrationController::class,'registrationPost2'])->name('registration.post2');


Route::get('Registration-Form3', [RegistrationController::class, 'registration3'])->name('registration3');
Route::post('Registration-Form3', [RegistrationController::class, 'registrationPost3'])->name('registration.post3');
